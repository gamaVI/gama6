      ...
      <div className="mx-auto max-w-7xl px-6 pb-24 pt-10 sm:pb-32 lg:flex lg:px-8 lg:py-40">
        ...
        <h1 className="text-4xl font-extrabold tracking-tight text-white sm:text-[5rem]">
          ...
          <div className="mt-24 sm:mt-32 lg:mt-16">
            <a href="https://gama6-organization.gitbook.io/product-docs/" className="inline-flex space-x-6">
              ...
              <span className="inline-flex items-center space-x-2 text-sm font-medium leading-6 text-gray-300">
                <GithubIcon height="40"/><span>Github</span>
                <ChevronRightIcon className="h-5 w-5 text-gray-500" aria-hidden="true" />
              </span>
            </a>
          </div>
          <h1 className="mt-10 text-3xl font-bold tracking-tight text-white sm:text-6xl">
            Analiza nepremičninskega trga na spletu
          </h1>
          <p className="mt-6 text-lg leading-8 text-gray-300">
          Dobrodošli v naši spletni aplikaciji, ki je namenjena pregledu in analizi nepremičninskih transakcij. Naša platforma vam omogoča dostop do informacij o izvedenih nepremičninskih transakcijah na izbranem območju na zemljevidu. Poleg tega ponuja analitični vpogled v trenutne trende nepremičninskega trga, kar vam omogoča razumevanje in analizo tržnih dinamik.
          </p>
          <div className="mt-10 flex items-center gap-x-6">
              ...
              { providers?.auth0 && (
                  <Button
                  variant={"default"}
                    onClick={() => void signIn(providers.auth0.id, { callbackUrl: `${window.location.origin}/dashboard` })}
                  >
                    Vstopi
                  </Button>
                )} 
            ...
            <a href="#" className="text-sm font-semibold leading-6 text-white">
              Izvedi več <span aria-hidden="true">→</span>
            </a>
          </div>
        </div>
        <div className="mx-auto mt-16 flex max-w-2xl sm:mt-24 lg:ml-10 lg:mr-0 lg:mt-0 lg:max-w-none lg:flex-none xl:ml-32">
          <div className="max-w-3xl flex-none sm:max-w-5xl lg:max-w-none">
            <img
              src="https://i.imgur.com/QMt61nL.png"
              alt="App screenshot"
              width={2432}
              height={1442}
